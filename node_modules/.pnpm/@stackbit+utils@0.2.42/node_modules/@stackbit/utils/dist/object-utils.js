...
function deepMap(object, iteratee, options) {
    ...
    function _mapDeep(value, keyPath, mappedValueStack) {
        ...
        if (invokeIteratee) {
            value =
                (options === null || options === void 0 ? void 0 : options.includeKeyPath) === false ? iteratee.call(context, value, object) : iteratee.call(context, value, keyPath, mappedValueStack, object);
        }
