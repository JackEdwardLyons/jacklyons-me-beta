...
function normalizeListField(field) {
    ...
    return {
        ...
        items: {
            type: 'string',
            ...((_b = field.items) !== null && _b !== void 0 ? _b : {})
        }
    };
}
