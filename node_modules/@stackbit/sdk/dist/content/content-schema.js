...
function joiSchemasForModels(config) {
    const modelSchemas = lodash_1.default.reduce(config.models, (modelSchemas, model) => {
        var _a;
        let joiSchema;
        if ((_a = model.__metadata) === null || _a === void 0 ? void 0 : _a.invalid) {
            ...
            if (utils_2.isDataModel(model) || utils_2.isPageModel(model)) {
                objectLabel = 'file';
            }
...
function joiSchemaForModel(model, config) {
    if (utils_2.isDataModel(model) && model.isList) {
...
function joiSchemaForField(field, config, fieldPath) {
    ...
    switch (field.type) {
        ...
        case 'color':
            ...
            break;
        case 'image':
            fieldSchema = joi_1.default.alternatives([
                joi_1.default.string().allow('', null),
...
function stylePropTextDecorationSchema(styleConfig) {
    ...
    return joi_1.default.string().custom((value, { error, errorsArray }) => {
        var _a;
        const parts = (_a = value.split) === null || _a === void 0 ? void 0 : _a.call(value, ' ');
...
function stylePropSizeSchema(styleConfig) {
    ...
    const dirSchemas = lodash_1.default.reduce(styleConfig, (dirSchemas, pattern) => {
        ...
        lodash_1.default.forEach(directions, (direction) => {
            utils_1.append(dirSchemas, direction, valueSchema);
        });
        return dirSchemas;
    }, {});
